...
class DataTransformation:
        ...
        try:
            ...
            cat_pipeline = Pipeline(
                steps=[
                    ...
                    ("scaler", StandardScaler(with_mean=False))  # with_mean=False avoids errors in sparse matrices
                ]
            )

            logging.info("Numerical and categorical column transformation pipeline created successfully.")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info("Reading train and test data completed successfully.")
